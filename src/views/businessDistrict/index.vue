    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    <span class="labelSpan">商圈名称： </span>
                    <el-input class="SearchInput" v-model="queryParms.name" placeholder="请输入商圈名称"></el-input>
                </el-col>
                <el-col class="marginBottom" :span="8">
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                <el-table-column prop="name" label="商圈名称" align="center"></el-table-column>
