    ...
    <div v-loading="loading">
        ...
        <div class="searchBox">
            <el-row v-model="queryParms" :gutter="20" class="operation">
                <el-col class="marginBottom" :span="8">
                    ...
                    <!-- <el-input class="SearchInput" v-model="queryParms.couponNo" placeholder="请输入代金券"></el-input> -->
                     <el-select class="SearchInput" v-model="queryParms.couponNo" clearable placeholder="请选择">
                        <el-option
        ...
        <div class="resultBox">
            ...
            <el-table :data="list" border style="width: 100%">
                <el-table-column prop="couponNo" label="代金券" align="center" :formatter="couponFormat"></el-table-column>
